...
/*   Updated: 2023/07/27 17:12:54 by sanghwal         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */

#include "iter.hpp"

void	sqrtWrapper(double& data) {
	data = std::pow(data, 2);
}
...
int	main(void) {
	...
	::iter(int_arr, arrLen(int_arr), printData<int>); std::cout << "\n";
	::iter(int_arr, arrLen(int_arr), plusOne<int>);
	::iter(int_arr, arrLen(int_arr), printData<int>); std::cout << "\n";

	::iter(char_arr, arrLen(char_arr), printData<char>); std::cout << "\n";
	::iter(char_arr, arrLen(char_arr), plusOne<char>);
	::iter(char_arr, arrLen(char_arr), printData<char>); std::cout << "\n";

	::iter(double_arr, arrLen(double_arr), printData<double>); std::cout << "\n";
