...
int	main()
{
	...
	printf("ex01\n");
	printf("s1 : %s\ns2 : %s\n", ex00_s1, ex00_s2);
	printf("strncmp, n=0 : %d\nstrncmp, n=8 : %d\n", strncmp(ex00_s1,ex00_s2, 0), strncmp(ex00_s1, ex00_s2, 8));
	printf("ft_strncmp, n=0 : %d\nft_strncmp, n=8 : %d\n\n\n", ft_strncmp(ex00_s1,ex00_s2, 0), ft_strncmp(ex00_s1, ex00_s2, 8));
